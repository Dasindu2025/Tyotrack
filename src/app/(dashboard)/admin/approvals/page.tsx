                  ...
                  <CardContent className="py-4">
                    <div className="flex items-start justify-between gap-4">
                      <div className="flex items-start gap-4">
                        <div className="h-12 w-12 rounded-full bg-gradient-to-br from-neon-cyan to-neon-purple flex items-center justify-center text-dark-600 font-semibold">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-400">
                            {format(new Date(approval.entry.date), "EEEE, MMMM d, yyyy")}
                          </p>
                          ...
                          <div className="mt-3 space-y-2">
                            {approval.entry.segments.map((seg: any) => (
                              ...
                              >
                                ...
                                />
                                <span className="text-gray-300">{seg.project?.name}</span>
